...
declare module "@salesforce/schema/Case.Date_Due__c" {
  const Date_Due__c:any;
  export default Date_Due__c;
}
declare module "@salesforce/schema/Case.Date_Reported__c" {
  const Date_Reported__c:any;
  export default Date_Reported__c;
}
declare module "@salesforce/schema/Case.Vehicle__r" {
  const Vehicle__r:any;
  export default Vehicle__r;
}
declare module "@salesforce/schema/Case.Vehicle__c" {
  const Vehicle__c:any;
  export default Vehicle__c;
}
